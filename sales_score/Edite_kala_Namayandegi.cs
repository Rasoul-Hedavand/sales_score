...
namespace sales_score
{
    ...
    public partial class Edite_kala_Namayandegi : Form
    {
        ...
        public Edite_kala_Namayandegi(string productName, string productType, string productPelak, string productPrice, string productPelak_Seri,
         string productColor, string productSSH, string productSTM, string productNumber, string productsanad, DateTime date, DataGridView dataGridView1, int rowIndex)
        {
        ...
        public Edite_kala_Namayandegi(string productName, string productType, string productPelak, string productPrice, string productPelak_Seri, string productColor, string productSSH, string productSTM, string productNumber, DateTime date, DataGridView dataGridView1, int rowIndex)
        {
        ...
        private void Edite_kala_Load(object sender, EventArgs e)
        {
        ...
        private void panel1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                int deltaX = e.Location.X - offset.X;
                int deltaY = e.Location.Y - offset.Y;
